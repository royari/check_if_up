...
# backup = 255-backup    #colour inversion
    ...
    '''
    Uncomment the below code to display the the devided image of the captcha
    
    '''
    # imshow(torchvision.utils.make_grid(imgTensor), 30) #displays the captcha after segmentation 
    return imgTensor
